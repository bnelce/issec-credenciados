    ...
    <footer className="bg-gray-100">
      <div className="mx-auto max-w-5xl justify-center text-center flex flex-col items-center px-4 py-16 sm:px-6 lg:px-8">
        ...
        <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500">
          ...
          visando contribuir com o Instituto de Saúde dos Servidores do Estado
          do Ceará - ISSEC
        </p>
 ...
 */}
        <ul className="mt-12 flex justify-center gap-6 md:gap-8">
          <li>
            <a
              href="https://www.facebook.com/abner.lima.oliveira"
              rel="noreferrer"
              target="_blank"
              className="text-gray-700 transition hover:text-gray-700/75"
            >
          ...
          <li>
            <a
              href="https://www.instagram.com/bnelce/"
              rel="noreferrer"
              target="_blank"
              className="text-gray-700 transition hover:text-gray-700/75"
            >
